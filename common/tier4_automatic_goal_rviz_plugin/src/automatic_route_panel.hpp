...
#ifndef AUTOMATIC_ROUTE_PANEL_HPP_
#define AUTOMATIC_ROUTE_PANEL_HPP_
...
{
class AutowareAutomaticRoutePanel : public rviz_common::Panel
...
public:
  explicit AutowareAutomaticRoutePanel(QWidget * parent = nullptr);
...
//   void onGoalListUpdated() override;
  ...
  QPushButton * set_route_button_{nullptr};
  QPushButton * load_folder_button_{nullptr};
  QPushButton * clear_route_button_{nullptr};

  std::vector<std::string> route_names_;
  std::vector<std::string> route_paths_;
};
}  // namespace automatic_route

#endif  // AUTOMATIC_ROUTE_PANEL_HPP_
